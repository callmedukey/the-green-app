...
export const ImagesSlider = ({
  ...
  return (
    <div
      className={cn(
        "overflow-hidden h-full min-h-[800px] w-full relative flex items-center justify-center",
        className
      )}
      style={{
        perspective: "1000px",
    ...
    >
      {areImagesLoaded && (
        ...
        >
          ...
          <Link
            href="/about"
            className="px-4 py-2 backdrop-blur-sm border bg-primary/10 border-primary/60 text-white mx-auto text-center rounded-full relative mt-4"
          >
            <span>About 더그린 →</span>
