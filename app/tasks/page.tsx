  ...
  return (
    <main className="pb-16">
      ...
      <section className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-4 text-white">
        <div className="pt-[200px] px-[78px] h-[450px] relative w-[550px] grid grid-rows-[200px_auto]">
          <Image
            src={construction}
            alt="건설"
            fill
          ...
          <div className="flex flex-col gap-y-[70px]">
            <h2 className="text-[32px] font-bold text-center">건축</h2>
            <p className="bg-finalGray/70 max-w-[365px] mx-auto break-keep p-2 font-medium w-full">
        ...
        <div className="pt-[200px] px-[78px] h-[450px] relative w-[550px] grid grid-rows-[200px_auto]">
          ...
          />
          <div className="flex flex-col gap-y-[70px]">
            <h2 className="text-[32px] font-bold text-center">인허가 컨설팅</h2>
        ...
        <div className="pt-[200px] px-[67px] h-[450px] relative w-[550px] grid grid-rows-[200px_auto]">
          <Image
            src={architecture}
            alt="설계"
            fill
          ...
          />
          <div className="flex flex-col gap-y-[70px]">
            <h2 className="text-[32px] font-bold text-center">설계</h2>
            <p className="bg-finalGray/70 max-w-[500px] break-keep p-2 font-medium w-full mx-auto">
        ...
        <div className="pt-[200px] px-[101px] h-[450px] relative w-[550px] grid grid-rows-[200px_auto]">
          <Image
            src={landscape}
            alt="조경"
            fill
          ...
          />
          <div className="flex flex-col gap-y-[70px]">
            <h2 className="text-[32px] font-bold text-center">조경</h2>
            <p className="bg-finalGray/70 max-w-[500px] break-keep p-2 font-medium w-full mx-auto">
