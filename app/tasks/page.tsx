  ...
  return (
    <main className="pb-16">
      ...
      <section className="max-w-6xl mx-auto w-full grid lg:grid-cols-2 justify-center gap-4 text-white">
        <div className="md:pt-[200px] md:px-[78px] h-[300px] w-full md:h-[450px] relative md:w-[550px] grid md:grid-rows-[200px_auto]">
          <Image
            src={construction}
            alt="건설"
            fill
            ...
            quality={100}
          />
          <div className="flex flex-col gap-y-2 md:gap-y-[70px] justify-center md:justify-start">
        ...
        <div className="md:pt-[200px] md:px-[67px] h-[300px] w-full md:h-[450px] relative md:w-[550px] grid md:grid-rows-[200px_auto]">
          <Image
            src={architecture}
            alt="설계"
            fill
        ...
        <div className="md:pt-[200px] md:px-[101px] h-[300px] w-full md:h-[450px] relative md:w-[550px] grid md:grid-rows-[200px_auto]">
          <Image
            src={landscape}
            alt="조경"
            fill
