  ...
  return (
    <main className="pb-16">
      ...
      <section className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-4 text-white">
        <div className="tasks-construction bg-cover bg-center h-[450px] grid grid-rows-[70%_30%] place-items-center items-center">
        ...
        <div className="tasks-consulting bg-cover bg-center h-[450px] grid grid-rows-[70%_30%] place-items-center items-center">
        ...
        <div className="tasks-architecture bg-cover bg-center h-[450px] grid grid-rows-[70%_30%] place-items-center items-center">
        ...
        <div className="tasks-landscape bg-cover bg-center h-[450px] grid grid-rows-[70%_30%] place-items-center items-center">
